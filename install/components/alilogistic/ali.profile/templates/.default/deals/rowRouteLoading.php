				...
				<div class="row">
					...
					<div class="col-xs-5">
						<p>
							...
							<?php
								echo Html::input("text","ROUTES_START[TOWN]",$route && isset($route['TOWN']) ? $route['TOWN'] : null,['class'=>'form-control town']);
							?>
						</p>
						<p>
							<label>Дата с:</label>
						...
						<p>
							...
							<?php
								echo Html::input("text","ROUTES_START[ORGANISATION]",$route && isset($route['ORGANISATION']) ? $route['ORGANISATION'] : null,['class'=>'form-control org']);
							?>
						</p>
						<p>
							<label>Контактное лицо:</label>
							<?php
								echo Html::input("text","ROUTES_START[PERSON]",$route && isset($route['PERSON']) ? $route['PERSON'] : null,['class'=>'form-control person']);
							?>
						</p>
					</div>
					<div class="col-xs-5">
						<p>
							...
							<?php
								echo Html::input("text","ROUTES_START[ADDRESS]",$route && isset($route['ADDRESS']) ? $route['ADDRESS'] : null,['class'=>'form-control address']);
							?>
						</p>
						<p>
							<label>Дата по:</label>
